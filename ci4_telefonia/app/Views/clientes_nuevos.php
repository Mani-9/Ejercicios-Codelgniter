...
<body>
  <div class="container ">
    <div class="row justify-content-center">
       <h2 class="d-flex justify-content-center modcontainer col-4 m-2">Nuevo cliente</h2>
     </div>
        <div class="row">
            <div class="col col-4 container formulario">
                <form action="agregar_cliente " method="post" class="modcontainer">
                    <div class="mb-3">
