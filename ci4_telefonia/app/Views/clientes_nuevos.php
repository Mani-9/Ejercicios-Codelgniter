            ...
            <div class="card-body ">
                <form action="<?= base_url('agregar_cliente') ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input type="number" id="txtId" name="txtId" class="form-control" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="txtCorreoElectronico" class="form-label"><i class="bi bi-envelope-at-fill"></i> Correo electrónico</label>
                        <input type="email" id="txtCorreoElectronico" name="txtCorreoElectronico" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="txtCalleAvenida" class="form-label"><i class="bi bi-signpost-split"></i> Calle/Avenida</label>
                        <input type="text" id="txtCalleAvenida" name="txtCalleAvenida" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="txtNumeroCasa" class="form-label"><i class="bi bi-house-fill"></i> Número de casa</label>
                        <input type="number" id="txtNumeroCasa" name="txtNumeroCasa" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="txtZona" class="form-label"><i class="bi bi-map-fill"></i> Zona</label>
                        <input type="number" id="txtZona" name="txtZona" class="form-control" required>
                    </div>
