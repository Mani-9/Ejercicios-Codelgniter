...
<body>
        ...
        <div class="collapse" id="navbarToggleExternalContent" data-bs-theme="dark">
            <div class="bg-dark p-4">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?= base_url('ver_planes')?>"><i class="bi bi-pip"></i>
                            Planes</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container border border-5 ">
        ...
        <div class="d-flex justify-content-end ">
            <a href="<?php echo base_url('agregar_linea_telefonica'); ?>" class="btn btn-dark col-12 col-md-6 col-lg-4 mt-2 m-2">
                <h4>Agregar nueva linea telefonica</h4>
            </a>
        </div>
        ...
        ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url('buscar_linea_telefonica/').$lineas_telefonicas['no_telefono']?>" class="btn btn-info"><i
                                    class="bi bi-pencil-square"></i> Editar </a>
                            <a href="<?=base_url('eliminar_linea_telefonica/').$lineas_telefonicas['no_telefono']?>" class="btn btn-danger"><i
