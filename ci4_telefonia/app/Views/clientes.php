...
<body>
    ...
    <div class="container p-4">
        <div class="row justify-content-center">
            <h2 class="d-flex justify-content-center p-2 col-4">Clientes</h2>
        </div>
        <div class="d-flex justify-content-end ">
            <a href="<?php echo base_url('agregar_cliente'); ?>" class="btn btn-dark col-12 col-md-6 col-lg-4 mt-2 m-2">
